...
class VisionTransformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_channels=3, num_classes=2, emb_size=512, num_heads=8, depth=6, mlp_dim=2048, dropout=0.1):
        super().__init__()
...
# Dataset personalizado para Chest X-ray
...
if __name__ == '__main__':
    ...
    train_dataset = ChestXrayDataset(root_dir=r'data\chest_xray\train', transform=transform)
    val_dataset = ChestXrayDataset(root_dir=r'data\chest_xray\val', transform=transform)
    test_dataset = ChestXrayDataset(root_dir=r'data\chest_xray\test', transform=transform)
    ...
    # Inicializar o wandb
    setup_wandb(project_name='Chest-Xray-Pneumonia', run_name='Vision Transformer', config=config)
    ...
    torch.save(model.state_dict(), 'models/vision_transformer_chest_xray.pth')
